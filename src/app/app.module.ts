...
import { PaymentsComponent } from './passenger-detials/payments.component';
import { PassengerDetialsComponent } from './passenger-detials/passenger-detials.component';
import { UserViewFlightsComponent } from './user-view-flights/user-view-flights.component';
...
@NgModule({
  declarations: [
    ...
    UserPanelComponent,
    PaymentsComponent,
    PassengerDetialsComponent,
    UserViewFlightsComponent,
