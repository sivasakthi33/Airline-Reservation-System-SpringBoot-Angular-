...
export class ScheduledFlightService {
  ...
  addScheduleFlight(scheduleFlight:ScheduledFlight = {
    scheduleFlightId: 0,
    flight: {action: false,flightNo: 0, flightName: '',flightLogo:'', flightModel: '',rate:0,  seatCapacity: 0},
    schedule:{scheduleId: 0, srcAirport: { action: false, airportCode: '', airportLocation: '', airportName: ''}, dstnAirport: { action: false, airportCode: '', airportLocation: '', airportName: ''}, deptDateTime: '' , arrDateTime: ''},
    availableSeats: 0},
    srcAirport: any ,dstnAirport: any,deptDateTime: any,arrDateTime: any){
